...
wire pht1_match;
wire pht1_weak;
pht_t1_7_32_128 #(.INDEX_SIZE(7), .TAG_SIZE(7), .GHR_LEN(32)) pht_table1
    (
    .reset(reset),
    .clk(clk),
    .GHR(GHR),
...
wire pht2_match;
wire pht2_weak;
pht_t2_8_64_128 #(.INDEX_SIZE(8), .TAG_SIZE(8), .GHR_LEN(64)) pht_table2
    (
    .reset(reset),
    .clk(clk),
    .GHR(GHR),
...
wire pht3_match;
wire pht3_weak;
pht_t3_9_128_128 #(.INDEX_SIZE(9), .TAG_SIZE(9), .GHR_LEN(128)) pht_table3
    (
    .reset(reset),
    .clk(clk),
    .GHR(GHR),
