...
wire pht1_match;
wire pht1_weak;
pht_t1_7_16 #(.INDEX_SIZE(7), .TAG_SIZE(7), .GHR_LEN(16)) pht_table1
    (
    .reset(reset),
    .clk(clk),
    .GHR(GHR),
...
wire pht2_match;
wire pht2_weak;
pht_t2_9_32 #(.INDEX_SIZE(9), .TAG_SIZE(9), .GHR_LEN(32)) pht_table2
    (
    .reset(reset),
    .clk(clk),
    .GHR(GHR),
...
wire pht3_match;
wire pht3_weak;
pht_t3_11_64 #(.INDEX_SIZE(11), .TAG_SIZE(11), .GHR_LEN(64)) pht_table3
    (
    .reset(reset),
    .clk(clk),
    .GHR(GHR),
