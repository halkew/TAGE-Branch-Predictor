...
module pht_t3 #(parameter INDEX_SIZE = 6, parameter TAG_SIZE = 6, parameter GHR_LEN = 64)
    (
    input reset,
    input clk,
    input [63:0] GHR,
...
//    ^GHR_usable[51:48] ^ GHR_usable[55:52] ^ GHR_usable[59:56] ^ GHR_usable[63:60];
    wire [INDEX_SIZE - 1:0] index = folded_pc ^ GHR_usable[5:0]    ^ GHR_usable[11:6]  ^ GHR_usable[17:12] ^
                GHR_usable[23:18]  ^ GHR_usable[29:24] ^ GHR_usable[35:30] ^
                GHR_usable[41:36]  ^ GHR_usable[47:42] ^ GHR_usable[53:48] ^
                GHR_usable[59:54]  ^ GHR_usable[63:60];
                    
    wire [5:0] folded_ghr6;
    wire [4:0] folded_ghr5;
    
    folder_6b f1(.fold(GHR_usable),.folded(folded_ghr6));
//    folder_5b f2(.fold(GHR_usable),.folded(folded_ghr5));
       
    
//    wire [TAG_SIZE - 1:0] tag = PC[TAG_SIZE - 1:0] ^ folded_ghr6 ^ (folded_ghr5 << 1);
