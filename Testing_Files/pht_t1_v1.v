...
module pht_t1_v1 #(parameter INDEX_SIZE = 5, parameter TAG_SIZE = 5, parameter GHR_LEN = 4)
    (
    input reset,
    input clk,
    input [63:0] GHR,
    ...
    wire [4:0] folded_pc5;
    folder_5b f1(.fold({48'b0,PC}),.folded(folded_pc5));
    ...
    wire [INDEX_SIZE - 1:0] index = {GHR_usable[GHR_LEN-1:0]} ^ folded_pc5;//PC[5:0];
