...
module pht_t2_v1 #(parameter INDEX_SIZE = 6, parameter TAG_SIZE = 6, parameter GHR_LEN = 32)
    (
    input reset,
    input clk,
    input [127:0] GHR,
...
//    folder_5b f1(.fold({48'b0,GHR_usable}),.folded(folded_ghr5));
    folder_6b_128 f2(.fold({96'b0,GHR_usable}),.folded(folded_ghr6));
    
    wire [INDEX_SIZE - 1:0] index = folded_ghr6 ^ folded_pc6;//PC[4:0];
