...
module pht_t2_8_32_128 #(parameter INDEX_SIZE = 8, parameter TAG_SIZE = 8, parameter GHR_LEN = 32)
    (
    input reset,
    input clk,
    input [127:0] GHR,
    ...
    ^ GHR_usable[23:16] ^ GHR_usable[31:24] ^ folded_pc;
    
    wire [7:0] folded_ghr8;
    
//    folder_6b f2(.fold({48'b0,GHR_usable}),.folded(folded_ghr6));
    folder_8b_128 f2(.fold({96'b0,GHR_usable}),.folded(folded_ghr8));
