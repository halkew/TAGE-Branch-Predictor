...
module pht_t2_8_32 #(parameter INDEX_SIZE = 8, parameter TAG_SIZE = 8, parameter GHR_LEN = 32)
    (
    input reset,
    input clk,
    input [63:0] GHR,
