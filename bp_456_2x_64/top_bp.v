...
wire pht1_match;
wire pht1_weak;
pht_t1 #(.INDEX_SIZE(4), .TAG_SIZE(4), .GHR_LEN(16)) pht_table1
    (
    .reset(reset),
    .clk(clk),
    .GHR(GHR),
...
wire pht2_match;
wire pht2_weak;
pht_t2 #(.INDEX_SIZE(5), .TAG_SIZE(5), .GHR_LEN(32)) pht_table2
    (
    .reset(reset),
    .clk(clk),
    .GHR(GHR),
...
wire pht3_match;
wire pht3_weak;
pht_t3 #(.INDEX_SIZE(6), .TAG_SIZE(6), .GHR_LEN(64)) pht_table3
    (
    .reset(reset),
    .clk(clk),
    .GHR(GHR),
